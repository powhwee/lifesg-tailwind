...
import { allLeafPaths, firstLeafOf, leafByPath } from "@/components/content/registry";
...
export default async function ContentPage({
  ...
  if (slug.length === 1) {
    ...
    if (!direct) {
      ...
      if (target) redirect(`/content/${target}`);
      notFound();
    }
  }
