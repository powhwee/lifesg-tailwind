...
import { allLeafPaths, firstLeafOf, leafByPath } from "@/components/navigation/registry";
...
export default async function NavigationPage({
  ...
  if (slug.length === 1) {
    ...
    if (!direct) {
      ...
      if (target) redirect(`/navigation/${target}`);
      notFound();
    }
  }
