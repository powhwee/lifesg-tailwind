...
import { allLeafPaths, firstLeafOf, leafByPath } from "@/components/selection-and-input/registry";
...
export default async function SelectionAndInputPage({
  params,
}: {
  ...
  if (slug.length === 1) {
    ...
    if (!direct) {
      ...
      if (target) redirect(`/selection-and-input/${target}`);
      notFound();
    }
  }
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="grid grid-cols-2 flex-1">
        <section
          ...
          data-testid="selection-and-input-ours"
        >
        ...
        <section
          ...
          className="p-8"
          data-testid="selection-and-input-lifesg"
        >
          <div className="text-xs uppercase tracking-wide text-muted-foreground mb-4">
            LifeSG (reference)
          </div>
