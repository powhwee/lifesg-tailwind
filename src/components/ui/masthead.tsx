...
function SGCrest({ className }: { className?: string }) {
  ...
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      className={cn("text-[var(--masthead-crest)]", className)}
    >
  ...
  return (
    <Collapsible.Root>
      <div
        data-slot="masthead"
        className={cn(
          "w-full bg-[var(--masthead-bg)] text-[var(--masthead-text)] [font-size:var(--masthead-font-size)] [line-height:var(--masthead-line-height)]",
          className
        )}
        {...rest}
      >
        <div className={cn(stretch ? "w-full px-4" : "max-w-screen-xl mx-auto px-4")}>
              ...
              <Collapsible.Trigger
                render={(triggerProps, state) => (
                  <button
                    {...triggerProps}
                    className={cn(
                      "inline-flex items-center gap-1 self-start mt-0.5 underline-offset-4 hover:underline text-[var(--masthead-link)] outline-none focus-visible:underline",
          ...
          <Collapsible.Panel className="overflow-hidden h-[var(--collapsible-panel-height)] transition-[height] duration-200">
            <div className="py-3 grid grid-cols-1 md:grid-cols-2 gap-4 text-[0.8125rem]">
              <div className="flex gap-2">
                <Globe size={18} className="shrink-0 mt-0.5 text-[var(--masthead-icon)]" />
                <div>
                  <p className="font-semibold mb-0.5">Official website links end with .gov.sg</p>
                  <p className="text-[var(--lifesg-text-subtle)]">
              ...
              <div className="flex gap-2">
                <Lock size={18} className="shrink-0 mt-0.5 text-[var(--masthead-icon)]" />
                <div>
